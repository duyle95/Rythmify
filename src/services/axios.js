// https://github.com/palampinen/replayify/blob/master/src/services/axios.js
...
export const getActionTypes = (
  ...
  if (typeof action.type !== "undefined") {
    ...
    throw new Error(
      'Action needs to have "type" or "types" key which is not null'
    );
  }
  return types;
};

export const getErrorActionType = (action, options) =>
